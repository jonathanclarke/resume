...
\employer{Undergraduate Thesis Research}{Development of a Web-Based Water Wave Viewer}{2008-2009}{
	...
	\item{Collaborated with Mathematics professors to create a prototype web application for visualizing and exploring large data sets. Ported \Cpp\, command-line client to Python using Python wrappers. Designed and implemented a web viewer to browse and display existing results. \kt Python, NumPy, Trilinos, SWIG, gnuplot, XML, HTML, CSS2, jQuery, Flot.}
