...
\employer{BzzAgent, Inc.}{Java Engineer}{2011 - Present}{
	...
	\item{Responsible for developing the BzzAgent platform, \texttt{bzzagent.com}, as the business model evolves: design and implementation of new features, retiring old features, and paying down technical debt. Improving code quality with unit tests, FindBugs, and peer code review. Participating in and working to improve the team's Scrum process. Built a JSON API which underpins the BzzAgent iOS app. \kt Java, Tomcat, Play Framework, JAX-RS, PostgreSQL, JSP/Struts, Stripes, JDBC, Apache Commons, Guava, JUnit, Git.}
